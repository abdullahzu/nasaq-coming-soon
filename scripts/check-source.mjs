...
const checks = [
  ...
  [html.includes("التدفق قبل المساحة"), "Approved Arabic short slogan must be present"],
  [client.includes('slogan: "Flow Before Space"'), "Approved English short slogan must be present"],
